...
$nigeria = [
   'Abia'=> [
    ...
    'Adamawa'=>[
        'cities' => [
            'Demsa', 'Fufure', 'Ganye', 'Gayuk', 'Girei',
            'Gombi', 'Guyuk', 'Hong', 'Jada', 'Lamurde',
    ...
    'Oyo'=>[
        'cities' => [
            ...
            'Ogbomosho North', 'Ogbomosho South', 'Ogo Oluwa', 'Oluyole', 'Ona Ara',
...
if(isset($_GET['state']) && isset($nigeria[$_GET['state']])){
  header('Content-Type: application/json');
  echo json_encode($nigeria[$_GET['state']]);
}
